...
const MODEL_PATTERNS = {
  antigravity: [
    { match: /3\.7.*flash.*high|3\.7.*high.*flash/i,                alias: "gemini-3.7-flash-high" },
    { match: /3\.7.*flash.*medium|3\.7.*medium.*flash/i,            alias: "gemini-3.7-flash-medium" },
    { match: /3\.7.*flash.*low|3\.7.*low.*flash/i,                  alias: "gemini-3.7-flash-low" },
    { match: /3\.6.*flash.*high|3\.6.*high.*flash/i,                alias: "gemini-3.6-flash-high" },
    { match: /3\.6.*flash.*medium|3\.6.*medium.*flash/i,            alias: "gemini-3.6-flash-medium" },
    { match: /3\.6.*flash.*low|3\.6.*low.*flash/i,                  alias: "gemini-3.6-flash-low" },
...
// it through KTRouter to an external chat model makes typing laggy and burns provider quota per
...
module.exports = { IS_DEV, LSOF_BIN, TARGET_HOSTS, URL_PATTERNS, MODEL_SYNONYMS, MODEL_PATTERNS, MODEL_NO_MAP, LOG_BLACKLIST_URL_PARTS, getToolForHost, isBinaryData, extractModel };
