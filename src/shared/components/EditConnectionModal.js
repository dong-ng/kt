...
export default function EditConnectionModal({ isOpen, connection, proxyPools, onSave, onClose }) {
  ...
  const [antigravityClientProfile, setAntigravityClientProfile] = useState("ide");
  ...
  return (
    <Modal isOpen={isOpen} title="Edit Connection" onClose={onClose}>
      <div className="flex flex-col gap-4">
        ...
        {isAntigravity && (
          <Select
            label="Antigravity client profile"
            value={antigravityClientProfile}
            onChange={(e) => setAntigravityClientProfile(e.target.value)}
            options={[
              { value: "ide", label: "IDE Desktop" },
