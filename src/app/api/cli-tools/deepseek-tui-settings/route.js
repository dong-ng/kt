...
// Build TOML config for KTRouter (openai provider mode)
const buildKTRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect KTRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildKTRouterConfig(baseUrl, apiKey || "sk_ktrouter", model);
