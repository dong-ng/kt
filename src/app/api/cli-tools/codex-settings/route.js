...
const hasKTRouterConfig = (config) => {
  ...
  return config.includes("model_provider = \"ktrouter\"") || config.includes("[model_providers.ktrouter]");
};
...
export async function DELETE() {
  try {
    ...
    if (parsed.model_provider === "ktrouter") {
      delete parsed.model;
      delete parsed.model_provider;
    }

    // Remove ktrouter provider section
    deleteNestedSection(parsed, "model_providers.ktrouter");
