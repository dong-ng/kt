...
// and break recursive loops between ktrouter instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-ktrouter-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // ktrouter instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another ktrouter fetching our /models)
