...
export async function PUT(request, { params }) {
  try {
    ...
    if (
      ...
      if (existing.provider === "antigravity" && providerSpecificData?.clientProfile !== undefined) {
        updateData.providerSpecificData.clientProfile = providerSpecificData.clientProfile === "cli"
          ? "cli"
          : "ide";
      }
