 ...
 * API. They are ktrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic ktrouter variant set for a single upstream Kiro model.
 *
 ...
 * into ktrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
