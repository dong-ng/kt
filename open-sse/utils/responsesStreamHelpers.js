...
export function needsResponsesAbortTerminal(clientFormat) {
  return clientFormat === FORMATS.OPENAI_RESPONSES;
}

// Encoded response.failed + [DONE] payload for aborted/stalled Responses API streams
