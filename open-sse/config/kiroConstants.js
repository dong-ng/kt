 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what ktrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a ktrouter
...
/**
 * Detect whether a model id refers to a ktrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a ktrouter synthetic thinking variant
...
/**
 * Resolve a ktrouter model id to the real upstream Kiro model id, plus flags
