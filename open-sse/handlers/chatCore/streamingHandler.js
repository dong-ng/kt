...
import { buildAbortedResponsesTerminalBytes, needsResponsesAbortTerminal } from "../../utils/responsesStreamHelpers.js";
...
export async function handleStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, userAgent, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientRawRequest, onRequestSuccess, reqLogger, toolNameMap, streamController, onStreamComplete, streamDetailId, pxpipe, reqTag, log }) {
  ...
  // Any Responses API client needs a terminal event, including translated
  // streams such as Antigravity -> Responses. Without it Codex retries the
  // broken transport indefinitely and remains stuck on "reconnecting".
  const onAbortTerminal = needsResponsesAbortTerminal(sourceFormat)
