...
import { ANTIGRAVITY_IDE_FALLBACK_VERSION } from "../services/antigravityVersion.js";
import { antigravityIdeUserAgent } from "../services/antigravityHeaders.js";
...
// Keep this static even when ktrouter runs on Linux: the provider profile is
// intentionally matching the IDE client, not the server host.
export const ANTIGRAVITY_IDE_VERSION = ANTIGRAVITY_IDE_FALLBACK_VERSION;
export const ANTIGRAVITY_IDE_BASE_URL = "https://daily-cloudcode-pa.googleapis.com";
export const ANTIGRAVITY_IDE_USER_AGENT = antigravityIdeUserAgent();
